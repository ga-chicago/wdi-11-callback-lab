...
Follow the following steps:
   1. Create a function called `wordReverse` that reverses a string word for word. Use chaining.
   2. Create a function called `letterReverse` that reverses a string letter for letter. Use chaining.
...
Read [this](https://github.com/ga-chicago/programming-concepts) thoroughly. 
